...
/**
 * Created by Yasmin on 04/06/2017.
 */
...
public class ConnectionThreadGravacao extends Thread {
    ...
    public ConnectionThreadGravacao() {
    ...
    public ConnectionThreadGravacao(String btDevAddress) {
        ...
        if(btSocket != null) {
            ...
            try {
                ...
                while(running) {
                    ...
                    toModoGravacao(Arrays.copyOfRange(buffer, 0, bytesRead-1));
    ...
    private void toModoGravacao(byte[] data) {
        ...
        ModoGravacao.handler.sendMessage(message);
